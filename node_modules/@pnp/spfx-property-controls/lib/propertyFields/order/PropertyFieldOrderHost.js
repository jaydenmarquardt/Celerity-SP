...
var PropertyFieldOrderHost = /** @class */ (function (_super) {
    ...
    function PropertyFieldOrderHost(props, state) {
        ...
        _this.cleanupSubscriptions = function () {
            while (_this._ddSubs.length) {
                var sub = _this._ddSubs.pop(); // eslint-disable-line @typescript-eslint/no-explicit-any
                sub.dispose();
            }
        };
        ...
        _this.moveItemAtIndexToTargetIndex = function (itemIndex, targetIndex) {
            if (itemIndex !== targetIndex && itemIndex > -1 && targetIndex > -1 && itemIndex < _this.state.items.length && targetIndex < _this.state.items.length) {
                var items = _this.state.items; // eslint-disable-line @typescript-eslint/no-explicit-any
                items.splice.apply(// eslint-disable-line @typescript-eslint/no-explicit-any
                items, __spreadArray([targetIndex, 0], items.splice(itemIndex, 1), false));
                _this.setState({
                    items: items
                });
        ...
        _this._ddSubs = new Array(); // eslint-disable-line @typescript-eslint/no-explicit-any
        _this._draggedItem = null;
        _this.state = {
            items: []
        };
    ...
    PropertyFieldOrderHost.prototype.UNSAFE_componentWillMount = function () {
        this.setState({
    ...
    PropertyFieldOrderHost.prototype.UNSAFE_componentWillUpdate = function (nextProps) {
