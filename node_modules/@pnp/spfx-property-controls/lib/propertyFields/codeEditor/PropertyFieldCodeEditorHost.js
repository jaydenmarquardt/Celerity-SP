    ...
    PropertyFieldCodeEditorHost.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Panel, { isOpen: this.state.openPanel, hasCloseButton: true, onDismiss: this.onClosePanel, isLightDismiss: true, type: this.props.panelWidth ? PanelType.custom : PanelType.medium, customWidth: this.props.panelWidth, headerText: this.props.panelTitle, isFooterAtBottom: true, styles: {
                ...
                }, onRenderFooterContent: function () { return (React.createElement("div", { className: styles.actions },
                ...
                React.createElement(AceEditor, { mode: this.props.language, theme: "monokai", onChange: this.onChange, value: this.state.code, name: "code-".concat(this.props.targetProperty), editorProps: { $blockScrolling: true }, setOptions: this.props.options, width: "100%", height: "100%" }))));
    };
