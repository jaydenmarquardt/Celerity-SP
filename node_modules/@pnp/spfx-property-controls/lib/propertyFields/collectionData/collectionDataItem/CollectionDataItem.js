...
var CollectionDataItem = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = (_b.sent());
                        _b.label = 2;
                    case 2: // eslint-disable-line @typescript-eslint/no-explicit-any
                    return [2 /*return*/, _a &&
    ...
    CollectionDataItem.prototype.renderField = function (field, item) {
        var _this = this;
        var disableFieldOnEdit = (field.disableEdit && !!this.props.fUpdateItem) || (field.disable && field.disable(item));
        switch (field.type) {
            ...
            case CustomCollectionFieldType.custom:
                if (field.onCustomRender) {
                    return field.onCustomRender(field, item[field.id], function (fieldId, value) {
                        _this.onValueChanged(fieldId, value).then(function () {
                            _this.fieldValidation(field, value).then(function () { }).catch(function () { });
                        }).catch(function () { });
    ...
    CollectionDataItem.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "PropertyFieldCollectionData__panel__table-row ".concat(styles.tableRow, " ").concat(this.props.index === null ? styles.tableFooter : "") },
            ...
            this.props.index !== null ? (React.createElement(Link, { title: strings.CollectionDeleteRowButtonLabel, disabled: !this.props.fDeleteItem || this.props.disableItemDeletion, onClick: this.deleteRow },
                React.createElement(Icon, { iconName: "Clear" }))) : (React.createElement(Link, { title: strings.CollectionAddRowButtonLabel, className: "".concat(disableAdd ? styles.addBtnDisabled : styles.addBtn), disabled: disableAdd, onClick: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    switch (_a.label) {
