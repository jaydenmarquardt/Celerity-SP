...
var PropertyFieldCollectionDataHost = /** @class */ (function (_super) {
    ...
    PropertyFieldCollectionDataHost.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Panel, __assign({ isOpen: this.state.panelOpen, onDismiss: this.closePanel, type: PanelType.large, headerText: this.props.panelHeader, onOuterClick: function () {
                    /* no-op; */
                }, className: "PropertyFieldCollectionData__panel ".concat(this.props.panelClassName || "") }, (_a = this.props.panelProps) !== null && _a !== void 0 ? _a : {}),
