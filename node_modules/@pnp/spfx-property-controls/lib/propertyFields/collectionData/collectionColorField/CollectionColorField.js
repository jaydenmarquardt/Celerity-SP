...
var CollectionColorField = /** @class */ (function (_super) {
     ...
     */
    CollectionColorField.prototype.UNSAFE_componentWillMount = function () {
        this.valueChange(this.props.field, this.props.item[this.props.field.id]).then(function () { }).catch(function () { });
    };
    CollectionColorField.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "PropertyFieldCollectionData__panel__color-field ".concat(styles.colorField, " ").concat(this.state.errorMessage ? styles.invalidField : "") },
