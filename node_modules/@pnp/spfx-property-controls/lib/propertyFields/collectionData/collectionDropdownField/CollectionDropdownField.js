...
export var CollectionDropdownField = function (_a) {
    ...
    React.useEffect(function () {
        if (item && field) {
            onValueChange(item[field.id]).then(function () { }).catch(function () { });
        }
    }, []);
    if (!field || !item) {
        return React.createElement(React.Fragment, null);
    }
    return React.createElement(Dropdown, { placeHolder: field.placeholder || field.title, options: options, selectedKey: item[field.id], required: field.required, disabled: disableEdit, onChange: function (e, i) { onValueChange(i.key).then(function () { }).catch(function () { }); }, onRenderOption: field.onRenderOption, className: "PropertyFieldCollectionData__panel__dropdown-field ".concat(errorMessage ? styles.invalidField : '') });
};
