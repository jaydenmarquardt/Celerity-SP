...
var FilePicker = /** @class */ (function (_super) {
    ...
    function FilePicker(props) {
        ...
        _this._handleOpenPanel = function () {
            _this.setState({
                panelOpen: true,
                selectedTab: _this.props.defaultSelectedTab ? _this.props.defaultSelectedTab : FilePickerTabType.RecentTab
            });
        };
        /**
         * Closes the panel
            ...
            React.createElement(Panel, { isOpen: this.state.panelOpen, isBlocking: true, hasCloseButton: true, className: "pnp__file-picker__panel ".concat(styles.filePicker, " ").concat(panelClassName), onDismiss: this._handleClosePanel, type: PanelType.extraLarge, isFooterAtBottom: true, onRenderNavigation: function () { return undefined; }, headerText: strings.FilePickerHeader, isLightDismiss: true, onRenderHeader: function () { return _this._renderHeader(); } },
                ...
                React.createElement("div", { className: styles.tabsContainer },
                    this.state.selectedTab === FilePickerTabType.LinkUploadTab &&
                        React.createElement(LinkFilePickerTab, __assign({ fileSearchService: this.fileSearchService, allowExternalLinks: this.props.allowExternalLinks, checkIfFileExists: this.props.checkIfFileExists !== false }, linkTabProps)),
                    ...
                    this.state.selectedTab === FilePickerTabType.SiteFilesTab &&
                        React.createElement(SiteFilePickerTab, __assign({ fileBrowserService: this.fileBrowserService, includePageLibraries: this.props.includePageLibraries }, linkTabProps)),
