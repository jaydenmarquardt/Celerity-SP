            ...
            return (React.createElement("div", { className: styles.listCell, "data-item-index": index, style: {
                ...
                React.createElement("div", { role: "presentation", className: styles.cell, 
                    ...
                    React.createElement("div", { role: "presentation", className: styles.cellContent }, item.isFolder ?
                        ...
                        :
                            React.createElement(DocumentTile, { fileBrowserService: _this.props.fileBrowserService, item: item, index: index, isSelected: isSelected, pageWidth: _this._pageWidth, tileDimensions: {
                                    width: _this._columnWidth - TILE_HORZ_PADDING,
                                    height: _this._rowHeight - TILE_HORZ_PADDING
                                }, onItemInvoked: function (itemInvoked) { return _this._handleItemInvoked(itemInvoked); } })))));
        };
    ...
    TilesList.prototype.render = function () {
        ...
        return (React.createElement(SelectionZone, { selection: this.props.selection, onItemInvoked: function (item) { _this._handleItemInvoked(item); } },
            React.createElement(FocusZone, null,
                React.createElement(List, { ref: function (e) {
                        var needToUpdate = !_this._listElem && !!e && !_this._columnWidth;
                        _this._listElem = e;
                        //
                    ...
                    }, className: styles.folderList, items: this.props.items, getItemCountForPage: this._getItemCountForPage, getPageHeight: this._getPageHeight, onRenderPage: function (pageProps, defaultRender) { return _this._onRenderPage(pageProps, defaultRender); } }))));
    };
    return TilesList;
}(React.Component));
export { TilesList };
