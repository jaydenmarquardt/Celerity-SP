...
var FileBrowser = /** @class */ (function (_super) {
    ...
    function FileBrowser(props) {
        ...
        */
            ...
            if (items[items.length - 1] !== null) // there are no more items to fetch from the server (there is no 'null' placeholder), we can sort client-side
             {
                ...
                items = items.concat([]).sort(function (a, b) {
                    ...
                    var sortFactor = isSortedDescending ? -1 : 1;
                ...
                if (column.fieldName === "name") {
                    var folders = items.filter(function (item) { return item.isFolder; });
                    var files = items.filter(function (item) { return !item.isFolder; });
                    items = __spreadArray(__spreadArray([], (isSortedDescending ? files : folders), true), (isSortedDescending ? folders : files), true);
                }
                ...
                _this.setState({
                    ...
                    _this._getListItems().then(function () { }).catch(function () { });
                });
            }
        };
        /**
                ...
                onRender: function (item) {
                    ...
                    var iconUrl = isPhoto
                        ...
                        : item.fileType.toLowerCase() === "aspx"
                            ...
                            : "https://res-1.cdn.office.net/files/fabric-cdn-prod_20220127.003/assets/item-types/20/".concat(item.fileType, ".svg");
        ...
        var currentSortColumn = columns.filter(function (c) { return c.isSorted === true; }); // TODO: switch to '.find' if/when this codebase upgrade to >= ES2015
        _this.state = {
            columns: columns,
            items: [],
    ...
    FileBrowser.prototype._getListItems = function (concatenateResults) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _a, libraryId, folderPath, accepts, nextPageQueryString, _b, items, currentSortColumnName, columns, currentSortColumn, isSortedDescending, filesQueryResult, loadingState, error_1, newItems;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.props, libraryId = _a.libraryId, folderPath = _a.folderPath, accepts = _a.accepts;
                        nextPageQueryString = this.state.nextPageQueryString;
                        _b = this.state, items = _b.items, currentSortColumnName = _b.currentSortColumnName, columns = _b.columns;
                        currentSortColumn = columns.filter(function (c) { return c.fieldName === currentSortColumnName; });
                        isSortedDescending = currentSortColumn.length ? currentSortColumn[0].isSortedDescending : false;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.props.fileBrowserService.getListItemsByListId(libraryId, folderPath, accepts, nextPageQueryString, currentSortColumnName, isSortedDescending)];
                    case 2:
