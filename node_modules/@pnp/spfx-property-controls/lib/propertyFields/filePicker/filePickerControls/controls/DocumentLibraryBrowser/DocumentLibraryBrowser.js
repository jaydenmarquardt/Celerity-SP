...
var DocumentLibraryBrowser = /** @class */ (function (_super) {
    ...
    DocumentLibraryBrowser.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function () {
            var includePageLibraries, lists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        includePageLibraries = this.props.includePageLibraries ? this.props.includePageLibraries : false;
                        return [4 /*yield*/, this.props.fileBrowserService.getSiteMediaLibraries(includePageLibraries)];
                    case 1:
                        lists = _a.sent();
                        this.setState({
                            lists: lists,
        ...
        return (React.createElement("div", { className: styles.documentLibraryBrowserContainer },
            React.createElement(FocusZone, null,
                React.createElement(List, { ref: function (e) {
                        var needToUpdate = !!e && !_this._columnWidth;
                        //
