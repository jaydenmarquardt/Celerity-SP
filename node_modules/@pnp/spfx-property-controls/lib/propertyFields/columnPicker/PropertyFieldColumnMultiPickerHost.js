...
*/
var PropertyFieldColumnMultiPickerHost = /** @class */ (function (_super) {
    __extends(PropertyFieldColumnMultiPickerHost, _super);
    /**
    * Constructor
    */
    function PropertyFieldColumnMultiPickerHost(props) {
    ...
    PropertyFieldColumnMultiPickerHost.prototype.componentDidMount = function () {
        this.loadColumns();
    };
    PropertyFieldColumnMultiPickerHost.prototype.componentDidUpdate = function (prevProps, prevState) {
        if (this.props.listId !== prevProps.listId ||
            this.props.webAbsoluteUrl !== prevProps.webAbsoluteUrl) {
            this.loadColumns();
        }
    };
    PropertyFieldColumnMultiPickerHost.prototype.loadColumns = function () {
        var _this = this;
        ...
        if (selectedColumns && selectedColumns.length) {
            ...
            if (typeof firstItem === 'string') {
                ...
                selectedColumnsKeys = selectedColumns.map(function (o) { return (columnReturnProperty ? o[columnReturnProperty] : o.Id); }); // eslint-disable-line @typescript-eslint/no-explicit-any
            }
        }
    ...
    */
    PropertyFieldColumnMultiPickerHost.prototype.onChanged = function (element, isChecked) {
        if (element) {
     ...
     */
    PropertyFieldColumnMultiPickerHost.prototype.onSelectAllChanged = function (element, isChecked) {
        if (element) {
    ...
    */
    PropertyFieldColumnMultiPickerHost.prototype.validate = function (value) {
        var _this = this;
    ...
    */
    PropertyFieldColumnMultiPickerHost.prototype.notifyAfterValidate = function (newValue) {
    ...
    */
    PropertyFieldColumnMultiPickerHost.prototype.componentWillUnmount = function () {
        this.async.dispose();
    };
    /**
    * Renders the SPColumnMultiplePicker controls with Office UI  Fabric
    */
    PropertyFieldColumnMultiPickerHost.prototype.render = function () {
        var _this = this;
        ...
        if (this.loaded === false) {
            ...
            return (React.createElement("div", null,
                ...
                results && results.length > 0 ? (React.createElement(React.Fragment, null, results.map(function (item, index) {
    ...
    return PropertyFieldColumnMultiPickerHost;
}(React.Component));
export default PropertyFieldColumnMultiPickerHost;
