...
var PropertyFieldColorPickerHost = /** @class */ (function (_super) {
    ...
    PropertyFieldColorPickerHost.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "".concat(styles.pfColorPicker, " ").concat(this.props.isHidden ? styles.hidden : "") },
                            ...
                            React.createElement("td", { style: { width: "100%" } },
                                this.state.inlinePickerShowing &&
                                    React.createElement("div", { className: "ms-slideDownIn20" },
                                        React.createElement(ColorPicker, { color: this.props.selectedColor, onChange: function (e, color) { return _this.props.onColorChanged(color.str); }, alphaSliderHidden: this.props.alphaSliderHidden, showPreview: this.props.showPreview, strings: strings.ColorPickerStrings })),
                                !this.state.inlinePickerShowing &&
