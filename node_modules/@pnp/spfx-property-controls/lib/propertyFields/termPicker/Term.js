...
var Term = /** @class */ (function (_super) {
     ...
     * @param nextProps
     */
    Term.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
        var _this = this;
    ...
    Term.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "".concat(styles.listItem, " ").concat(styles.term), style: styleProps }, this.props.isTermSelectable ?
