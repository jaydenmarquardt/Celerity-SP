...
var TermSet = /** @class */ (function (_super) {
    ...
    TermSet.prototype._autoLoadTerms = function () {
        ...
        this._loadTerms(true).then(function () { }).catch(function () { });
    };
    /**
    ...
    TermSet.prototype._handleClick = function () {
        ...
        if (!this.state.expanded) {
            this._loadTerms().then(function () { }).catch(function () { });
        }
    };
    /**
    ...
    TermSet.prototype._loadTerms = function (autoExpand) {
        return __awaiter(this, void 0, void 0, function () {
            var terms, _a, anchorTerm_1, anchorTermPath_1, anchorTerms;
            var _this = this;
                    ...
                    case 3:
                        ...
                        if (terms !== null) {
                            if (this.props.anchorId) {
                                anchorTerm_1 = terms.filter(function (t) { return t.Id.toLocaleLowerCase() === _this.props.anchorId.toLocaleLowerCase(); }).shift();
                                if (anchorTerm_1) {
    ...
    TermSet.prototype.render = function () {
        ...
        if (this.state.expanded) {
            if (this.state.loaded) {
                if (this.state.terms.length > 0) {
                    ...
                    termElm = React.createElement("div", { className: "".concat(styles.listItem, " ").concat(styles.term) }, strings.TermPickerNoTerms);
                }
            }
            else {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "".concat(styles.listItem, " ").concat(styles.termset, " ").concat(this.props.isTermSetSelectable && !this.props.areTermsHidden && !this.props.anchorId ? styles.termSetSelectable : ""), onClick: this._handleClick },
                React.createElement("img", { className: "".concat(this.props.areTermsHidden ? styles.termsHidden : ""), src: this.state.expanded ? EXPANDED_IMG : COLLAPSED_IMG, alt: strings.TermPickerExpandTitle, title: strings.TermPickerExpandTitle }),
