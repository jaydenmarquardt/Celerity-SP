...
var TermGroup = /** @class */ (function (_super) {
    ...
    function TermGroup(props) {
        ...
        if (selectedTermsInGroup.length > 0) {
            _this._loadTermSets(true).then(function () { }).catch(function () { });
        }
    ...
    TermGroup.prototype._handleClick = function () {
        ...
        if (!isExpanded) {
            this._loadTermSets().then(function () { }).catch(function () { });
        }
    };
    /**
    ...
    TermGroup.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "".concat(styles.listItem), onClick: this._handleClick },
