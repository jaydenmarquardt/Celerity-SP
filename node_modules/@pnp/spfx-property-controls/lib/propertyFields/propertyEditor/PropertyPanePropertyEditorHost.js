...
var PropertyPanePropertyEditorHost = /** @class */ (function (_super) {
    ...
    function PropertyPanePropertyEditorHost(props, state) {
        ...
        _this.onSave = function () {
            ...
            for (var propName in newProperties) {
                ...
                if (typeof ((_a = _this.props.webpart.properties[propName]) === null || _a === void 0 ? void 0 : _a.onChange) !== 'undefined' && ((_b = _this.props.webpart.properties[propName]) === null || _b === void 0 ? void 0 : _b.onChange) !== null) {
    ...
    PropertyPanePropertyEditorHost.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(Panel, { isOpen: this.state.openPanel, hasCloseButton: true, onDismiss: this.onClosePanel, isLightDismiss: true, type: PanelType.medium, headerText: strings.EditPropertiesPanelHeaderText, onRenderFooterContent: function () { return (React.createElement("div", { className: styles.actions },
