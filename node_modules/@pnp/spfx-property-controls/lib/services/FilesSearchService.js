            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        searchApi = "".concat(this.context.pageContext.web.absoluteUrl, "/_api/search/postquery");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        apiUrl = "https://api.cognitive.microsoft.com/bing/v7.0/images/search?traffictype=Internal_monitor&q=".concat(encodeURIComponent(query), "&count=").concat(maxResults, "&aspect=").concat(aspect, "&maxFileSize=").concat(maxFileSize, "&mkt=en-US&size=").concat(size, "&license=").concat(license);
                        headers = new Headers({
                    ...
                    case 1:
                        ...
                        if (!searchDataResponse || !searchDataResponse.ok) {
                            throw new Error("Something went wrong when executing search query. Status='".concat(searchDataResponse.statusMessage, "'"));
                        }
