            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        queryUrl = "".concat(webAbsoluteUrl, "/_api/lists(guid'").concat(this.props.listId, "')/Fields?$select=Title,Id,InternalName");
                        ...
                        if (this.props.filter) {
                            if (displayHiddenColumns)
                                ...
                                queryUrl += "&$filter=Hidden eq false and ".concat(encodeURIComponent(this.props.filter));
                        }
                        else {
                            if (!displayHiddenColumns)
