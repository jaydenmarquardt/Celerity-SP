                        ...
                        if (termsetNameOrId) {
                            for (var _b = 0, _c = group.TermSets._Child_Items_; _b < _c.length; _b++) {
                                ...
                                if (termSet.Name === termsetNameOrId || termSet.Id.indexOf(termsetNameOrId) !== -1) {
                                    termSets = __spreadArray(__spreadArray([], termSets, true), [termSet], false);
                                }
                            }
                        }
                        else {
                            termSets = __spreadArray(__spreadArray([], termSets, true), group.TermSets._Child_Items_, true);
                        }
                    }
                }
            }
