...
var OrgAssetsService = /** @class */ (function (_super) {
    ...
    function OrgAssetsService(context, itemsToDownloadCount) {
        ...
        _this.getListItemsByListId = function (listId, folderPath, acceptedFilesExtensions, nextPageQueryStringParams) { return __awaiter(_this, void 0, void 0, function () {
            var filesQueryResult, libName, libFullUrl, queryStringParams, restApi, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filesQueryResult = { items: [], nextHref: null };
        ...
        _this.getSiteMediaLibraries = function (includePageLibraries) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var restApi, orgAssetsResult, orgAssetsData, libs, error_3;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 3:
                            error_3 = _a.sent();
                            console.error("[OrgAssetsService.getOrganisationAssetsLibraries]: Err='".concat(error_3.message, "'"));
                            return [2 /*return*/, null];
