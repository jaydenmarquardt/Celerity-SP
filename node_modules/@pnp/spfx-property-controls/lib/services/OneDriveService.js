...
var OneDriveService = /** @class */ (function (_super) {
    ...
    function OneDriveService(context, itemsToDownloadCount) {
        ...
        _this.getListItemsByListId = function (listId, folderPath, acceptedFilesExtensions, nextPageQueryStringParams) { return __awaiter(_this, void 0, void 0, function () {
            var filesQueryResult, oneDriveRootFolder, encodedListUrl, queryStringParams, encodedFolderPath, restApi, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filesQueryResult = { items: [], nextHref: null };
        ...
        _this.getOneDriveRootFolderFullUrl = function () { return __awaiter(_this, void 0, void 0, function () {
            var oneDriveUrl, apiUrl, oneDriveFolderResult, oneDriveLibsData, myDocumentsLibrary, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
         ...
         */
        _this.getOneDrivePersonalLibraryId = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.oneDrivePersonalLibraryId) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.getOneDriveRootFolderFullUrl()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, this.oneDrivePersonalLibraryId];
                }
            });
        }); };
        /**
         ...
         */
        _this.getOneDriveMetadata = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.oneDriveRootFolderRelativeUrl) return [3 /*break*/, 2];
        ...
        _this.getOneDrivePersonalUrl = function () { return __awaiter(_this, void 0, void 0, function () {
            var userProfileApi, userProfileResult, profileData, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_4 = _a.sent();
                        console.error("[FileBrowserService.getOneDrivePersonalUrl] Err='".concat(error_4.message, "'"));
        ...
        _this.oneDrivePersonalLibraryId = null;
        return _this;
    }
