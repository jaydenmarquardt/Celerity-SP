...
var PnPTermStorePickerService = /** @class */ (function () {
                    ...
                    case 1:
                        ...
                        this._pnpTermStores.forEach(function (pnpTermStore) {
                            result.push({
                                ...
                                _ObjectIdentity_: pnpTermStore._ObjectIdentity_,
                                Id: pnpTermStore.Id,
    ...
    PnPTermStorePickerService.prototype.getTermSets = function () {
        return __awaiter(this, void 0, void 0, function () {
            var termSets, _loop_1, this_1, i, len;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                                    ...
                                    case 3:
                                        ...
                                        pnpGroups.forEach(function (pnpGroup) {
                                            pnpGroup.termSets.inBatch(batch_1).usingCaching().get().then(function (pnpTermSets) {
                                                termSets = __spreadArray(__spreadArray([], termSets, true), pnpTermSets.map(function (pnpTermSet) {
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, termSets];
                }
            });
        });
    };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        i++;
                        return [3 /*break*/, 2];
                    case 6: return [2 /*return*/, returnTerms];
                }
            });
        });
    };
