...
var FileBrowserService = /** @class */ (function () {
    function FileBrowserService(context, itemsToDownloadCount) {
        ...
        this.getListItems = function (libraryName, folderPath, acceptedFilesExtensions, nextPageQueryStringParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        restApi = "".concat(this.context.pageContext.web.absoluteUrl, "/_api/web/lists/GetByTitle('").concat(libraryName, "')/RenderListDataAsStream");
        ...
        this.getListItemsByListId = function (listId, folderPath, acceptedFilesExtensions, nextPageQueryStringParams, currentSortColumnName, isSortedDescending) { return __awaiter(_this, void 0, void 0, function () {
            var filesQueryResult, restApi, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filesQueryResult = { items: [], nextHref: null };
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        restApi = "".concat(this.context.pageContext.web.absoluteUrl, "/_api/web/lists(guid'").concat(listId, "')/RenderListDataAsStream");
                        // Do not pass FolderServerRelativeUrl as query parameter
                        // Attach passed nextPageQueryStringParams values to REST URL
                        if (nextPageQueryStringParams) {
                            restApi += "".concat(nextPageQueryStringParams);
                        ...
                        return [4 /*yield*/, this._getListDataAsStream(restApi, folderPath, acceptedFilesExtensions, currentSortColumnName, isSortedDescending)];
                    case 2:
                        filesQueryResult = _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
        ...
        this.getFileThumbnailUrl = function (file, thumbnailWidth, thumbnailHeight) {
            var thumbnailUrl = (file.spItemUrl && file.fileType === "aspx") // it's a SharePoint item, specifically a page
                ? "".concat(_this.context.pageContext.web.absoluteUrl, "/_layouts/15/getpreview.ashx?path=").concat(encodeURIComponent(file.absoluteUrl), "&resolution=0")
                : "".concat(_this.mediaBaseUrl, "/transform/thumbnail?provider=spo&inputFormat=").concat(file.fileType, "&cs=").concat(_this.callerStack, "&docid=").concat(file.spItemUrl, "&").concat(_this.driveAccessToken, "&width=").concat(thumbnailWidth, "&height=").concat(thumbnailHeight);
            return thumbnailUrl;
        };
        /**
        ...
        this.getSiteMediaLibraries = function (includePageLibraries) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var absoluteUrl, restApi, mediaLibrariesResult, libResults, result, error_3;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            restApi = "".concat(absoluteUrl, "/_api/SP.Web.GetDocumentAndMediaLibraries?webFullUrl='").concat(encodeURIComponent(absoluteUrl), "'&includePageLibraries='").concat(includePageLibraries, "'");
                        ...
                        case 3:
                            error_3 = _a.sent();
                            console.error("[FileBrowserService.getSiteMediaLibraries]: Err='".concat(error_3.message, "'"));
         ...
         * @param acceptedFilesExtensions
         */
        this._getListDataAsStream = function (restApi, folderPath, acceptedFilesExtensions, currentSortColumnName, isSortedDescending) { return __awaiter(_this, void 0, void 0, function () {
         ...
         */
        this.getFilesCamlQueryViewXml = function (accepts, currentSortColumnName, isSortedDescending) {
            var fileFilter = _this.getFileTypeFilter(accepts);
            var spSortColumnName = '';
            ...
            var queryCondition = fileFilter && fileFilter !== "" ?
                "<Query>\n        <Where>\n          <Or>\n            <And>\n              <Eq>\n                <FieldRef Name=\"FSObjType\" />\n                <Value Type=\"Text\">1</Value>\n              </Eq>\n              <Eq>\n                <FieldRef Name=\"SortBehavior\" />\n                <Value Type=\"Text\">1</Value>\n              </Eq>\n            </And>\n            <In>\n              <FieldRef Name=\"File_x0020_Type\" />\n              ".concat(fileFilter, "\n            </In>\n          </Or>\n        </Where>\n        ").concat(spSortColumnName ? "<OrderBy><FieldRef Name=\"".concat(spSortColumnName, "\" Ascending=\"").concat(isSortedDescending ? "FALSE" : "TRUE", "\"/></OrderBy>") : '', "\n        </Query>")
                : // no query is specified, but a sort might be...
                    spSortColumnName ? "<Query><OrderBy><FieldRef Name=\"".concat(spSortColumnName, "\" Ascending=\"").concat(isSortedDescending ? "FALSE" : "TRUE", "\"/></OrderBy></Query>")
        ...
        this.parseFileItem = function (fileItem) {
            var _a;
            var modifiedFriendlyRaw = fileItem["Modified.FriendlyDisplay"];
            // Get the modified date
            var modifiedParts = modifiedFriendlyRaw.split('|');
            var modifiedFriendly = modifiedParts.length === 2 ? modifiedParts[1] : fileItem.Modified; // If there is a friendly modified date, use that
            var file = {
        ...
        this.buildAbsoluteUrl = function (relativeUrl) {
            ...
            return "".concat(siteUrl).concat(relativeUrl);
        };
