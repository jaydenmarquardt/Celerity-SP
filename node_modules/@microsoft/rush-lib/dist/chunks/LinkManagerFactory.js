...
class BaseLinkManager {
    ...
    async createSymlinksForProjects(force) {
        ...
        _api_LastLinkFlag__WEBPACK_IMPORTED_MODULE_6__.LastLinkFlagFactory.getCommonTempFlag(this._rushConfiguration.defaultSubspace).create();
        stopwatch.stop();
        // eslint-disable-next-line no-console
...
class NpmLinkManager extends _base_BaseLinkManager__WEBPACK_IMPORTED_MODULE_6__.BaseLinkManager {
    ...
    _linkProject(project, commonRootPackage, commonPackageLookup) {
        ...
        if (!commonProjectPackage) {
            ...
            const tarballFile = path__WEBPACK_IMPORTED_MODULE_0__.join(this._rushConfiguration.commonTempFolder, _logic_RushConstants__WEBPACK_IMPORTED_MODULE_9__.RushConstants.rushTempProjectsFolderName, unscopedTempProjectName + '.tgz');
            // Example: "C:\MyRepo\common\temp\projects\project1\package.json"
...
class PnpmLinkManager extends _base_BaseLinkManager__WEBPACK_IMPORTED_MODULE_7__.BaseLinkManager {
    ...
    async _linkProjects() {
        if (this._rushConfiguration.projects.length > 0) {
            ...
            // eslint-disable-next-line no-console
            console.log(_rushstack_terminal__WEBPACK_IMPORTED_MODULE_6__.Colorize.yellow(`\nWarning: Nothing to do. Please edit ${_logic_RushConstants__WEBPACK_IMPORTED_MODULE_9__.RushConstants.rushJsonFilename} and add at least one project` +
