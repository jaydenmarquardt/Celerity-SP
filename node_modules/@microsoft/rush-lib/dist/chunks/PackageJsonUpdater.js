...
class PackageJsonUpdater {
    ...
    async doRushUpgradeAsync(options) {
        ...
        const { allVersionsByPackageName, implicitlyPreferredVersionByPackageName, commonVersionsConfiguration } = dependencyAnalyzer.getAnalysis();
        ...
        if (!skipUpdate) {
            if (this._rushConfiguration.subspacesFeatureEnabled) {
                const subspaceSet = this._rushConfiguration.getSubspacesForProjects(new Set(options.projects));
    ...
    async _doUpdate(debugInstall, subspace) {
        this._terminal.writeLine();
    ...
    async _getNormalizedVersionSpec(projects, packageName, initialSpec, implicitlyPreferredVersion, explicitlyPreferredVersion, rangeStyle) {
        ...
        await _installManager_InstallHelpers__WEBPACK_IMPORTED_MODULE_8__.InstallHelpers.ensureLocalPackageManager(this._rushConfiguration, this._rushGlobalFolder, _RushConstants__WEBPACK_IMPORTED_MODULE_6__.RushConstants.defaultMaxInstallAttempts);
        ...
        if (initialSpec && initialSpec !== 'latest') {
            ...
            if (localProject !== undefined) {
                ...
                const allVersions = _utilities_Utilities__WEBPACK_IMPORTED_MODULE_9__.Utilities.executeCommandAndCaptureOutput(this._rushConfiguration.packageManagerToolFilename, commandArgs, this._rushConfiguration.commonTempFolder);
                let versionList;
                if (this._rushConfiguration.packageManager === 'yarn') {
            ...
            if (localProject !== undefined) {
                ...
                selectedVersion = _utilities_Utilities__WEBPACK_IMPORTED_MODULE_9__.Utilities.executeCommandAndCaptureOutput(this._rushConfiguration.packageManagerToolFilename, commandArgs, this._rushConfiguration.commonTempFolder).trim();
            }
            this._terminal.writeLine();
