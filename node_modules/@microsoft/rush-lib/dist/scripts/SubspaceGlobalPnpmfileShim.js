...
function rewriteRushProjectVersions(packageName, dependencies) {
    ...
    const subspaceProject = settings.subspaceProjects[packageName];
    if (!subspaceProject) {
        return;
    }
    for (const dependencyName of Object.keys(dependencies)) {
        ...
        if (currentVersion.startsWith('workspace:')) {
            ...
            if (workspaceProjectInfo) {
                ...
                const relativePath = path__WEBPACK_IMPORTED_MODULE_0___default().normalize(path__WEBPACK_IMPORTED_MODULE_0___default().relative(subspaceProject.projectRelativeFolder, workspaceProjectInfo.projectRelativeFolder));
                ...
                if (aliasedWorkspaceProjectInfo) {
                    const relativePath = path__WEBPACK_IMPORTED_MODULE_0___default().normalize(path__WEBPACK_IMPORTED_MODULE_0___default().relative(subspaceProject.projectRelativeFolder, aliasedWorkspaceProjectInfo.projectRelativeFolder));
                    const newVersion = 'link:' + relativePath;
                    dependencies[dependencyName] = newVersion;
                }
            }
