 ...
 */
var PLACEHOLDERS_CHANGED_EVENT_NAME = 'placeholders.changedEvent';
/**
...
var PlaceholderManager = /** @class */ (function () {
    function PlaceholderManager(serviceScope) {
        ...
        this._changedEvent = new sp_core_library_2.SPEvent(PLACEHOLDERS_CHANGED_EVENT_NAME);
    ...
    PlaceholderManager.prototype.addPlaceholder = function (name, domElement) {
        ...
        sp_core_library_2._SPEventManager.instance.raiseStickyEvent(PLACEHOLDERS_CHANGED_EVENT_NAME, new sp_core_library_2.SPEventArgs());
    };
    /**
