 ...
 */
function loadScriptWithoutEval(address, appendJSExtension, isHubbleCorsUpdateKSActivated, isSpfxSubResourceIntegrityFlightEnabled // defaulting to false for systemJSLoader case
) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        var isCrossOrigin = (0, isCorsEnabled_1.default)(scriptUrl, isHubbleCorsUpdateKSActivated, isSpfxSubResourceIntegrityFlightEnabled);
