...
var RequireConfigurator = /** @class */ (function () {
    function RequireConfigurator(requireJs, useSecondaryCdn, skipBaseConfig) {
        ...
        this._isHubbleCorsUpdateKSActivated = (0, KillSwitches_1.isHubbleCorsUpdateKSActivated)();
        ...
        config.onNodeCreated = function (node, c, n, url) {
            ...
            if ((0, isCorsEnabled_1.default)(url, _this._isHubbleCorsUpdateKSActivated, _this._isSpfxSubResourceIntegrityFlightEnabled) ||
    ...
    RequireConfigurator.prototype._configurePathResource = function (name, resource, manifest, config, mapConfig) {
        ...
        if (existingNormalizedNameForAddress) {
            ...
            void (0, loadScriptWithoutEval_1.loadScriptWithoutEval)(address, true, this._isHubbleCorsUpdateKSActivated, this._isSpfxSubResourceIntegrityFlightEnabled);
        ...
        var handleManifest = function (resourceManifest) {
            ...
            if (moduleConfiguration.failoverPath) {
                ...
                if (!_this._configuredFailoverPaths.has(name)) {
                    ...
                    // Start downloading the script without evaluating it.
                    void (0, loadScriptWithoutEval_1.loadScriptWithoutEval)(address, true, _this._isHubbleCorsUpdateKSActivated, _this._isSpfxSubResourceIntegrityFlightEnabled);
