...
var IconPicker = /** @class */ (function (_super) {
    ...
    function IconPicker(props) {
        ...
        if (!(0, KillSwitches_1.isVivaEngageIconPatchKSActivated)() && props._extendedIcons) {
    ...
    IconPicker._excludedIcons = [
        'gallatinlogo',
        !(0, KillSwitches_1.isVivaEngageIconPatchKSActivated)() ? 'yammerlogo' : ''
    ];
    return IconPicker;
}(React.PureComponent));
