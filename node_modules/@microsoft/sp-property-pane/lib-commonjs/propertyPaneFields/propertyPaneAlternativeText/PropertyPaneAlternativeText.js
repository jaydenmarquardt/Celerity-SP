...
function getPropertyPaneToggleProperties(isDecorative, moduleName, dataAutomationId, controlName) {
    return tslib_1.__assign({ onText: !(0, KillSwitches_1.isAlternativeTextRedesignKSActivated)() ? undefined : Strings_resx_1.default.MarkImageAsDecorative, offText: !(0, KillSwitches_1.isAlternativeTextRedesignKSActivated)() ? undefined : Strings_resx_1.default.MarkImageAsDecorative, inlineLabel: !(0, KillSwitches_1.isAlternativeTextRedesignKSActivated)(), onAriaLabel: Strings_resx_1.default.OnAriaLabel, offAriaLabel: Strings_resx_1.default.OffAriaLabel, dataAutomationId: dataAutomationId, checked: isDecorative, _label: getToggleLabel() }, {
        logName: { moduleName: moduleName, controlName: controlName }
    });
}
function getToggleLabel() {
    return !(0, KillSwitches_1.isAlternativeTextRedesignKSActivated)() ? (react_1.default.createElement("div", { style: { display: 'inline-flex', fontWeight: 400, marginLeft: '-8px' } },
        ...
        react_1.default.createElement(office_ui_fabric_react_bundle_1.TooltipHost, { content: Strings_resx_1.default.DecorativeTooltipDesc, 
            ...
            react_1.default.createElement(office_ui_fabric_react_bundle_1.IconButton, { style: { marginTop: '8px' }, "aria-label": Strings_resx_1.default.IconAriaLabel, iconProps: { iconName: 'info' }, ariaDescription: Strings_resx_1.default.MarkImageAsDecorative })))) : (react_1.default.createElement("div", { style: { display: 'inline-flex' } },
        react_1.default.createElement(office_ui_fabric_react_bundle_1.Label, { "aria-label": Strings_resx_1.default.MarkImageAsDecorative }, Strings_resx_1.default.MarkImageAsDecorative),
        react_1.default.createElement(office_ui_fabric_react_bundle_1.TooltipHost, { content: Strings_resx_1.default.DecorativeTooltipDesc, 
            // eslint-disable-next-line react/jsx-no-bind
            onTooltipToggle: function (isOpen) {
                if (isOpen) {
            ...
            react_1.default.createElement(office_ui_fabric_react_bundle_1.IconButton, { "aria-label": Strings_resx_1.default.IconAriaLabel, iconProps: { iconName: 'info' }, ariaDescription: Strings_resx_1.default.MarkImageAsDecorative }))));
}
