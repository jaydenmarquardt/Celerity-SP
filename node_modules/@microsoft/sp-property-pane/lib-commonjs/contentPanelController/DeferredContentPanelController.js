...
var DCPC = /** @class */ (function () {
    function DCPC() {
        ...
        if ((0, Flights_1.isConfigurationToolsEnabled)() && !DCPC._contentPanelControllerPromise) {
            ...
            /* webpackChunkName: 'ContentPanelController' */ './ContentPanelController')); }).then(
            // eslint-disable-next-line @typescript-eslint/naming-convention
            function (_a) {
                var ContentPanelController = _a.ContentPanelController;
                _this._contentPanelController = ContentPanelController.isContentPanelSupported()
                    ? new ContentPanelController()
                    : undefined;
                if (!_this._contentPanelController) {
                    throw new Error(notSupported);
                }
            }, function (error) {
                var qosMonitor = new sp_diagnostics_1._QosMonitor('DeferredContentPanelController');
    ...
    DCPC.prototype.forceCloseContentPanel = function () { };
    ...
    tslib_1.__decorate([
        DCPC._implementLater
    ], DCPC.prototype, "forceCloseContentPanel", null);
    tslib_1.__decorate([
