...
var ContentPanelController = /** @class */ (function () {
    function ContentPanelController() {
        ...
        sp_pages_content_panel_context_1.SPPagesContentPanelProviderContext.getInstance().addOnMountListener(this._onContentPanelMount, function (error) {
            var qosMonitor = new sp_diagnostics_1._QosMonitor('ContentPanelController.loadCommands');
            sp_diagnostics_1._TraceLogger.logError(logSource_1.logSource, error);
    ...
    ContentPanelController.isContentPanelSupported = function () {
        return (sp_pages_content_panel_context_1.SPPagesContentPanelProviderContext.getInstance().isSupportedInCurrentEnvironment &&
    ...
    ContentPanelController.prototype.requestAction = function (toBeConfiguredConsumerId, propertyPaneAction, renderedByWebPart, context) {
        ...
        switch (propertyPaneAction) {
            case 'Open':
            case 'OpenDetails':
                this._openContentPanel(toBeConfiguredConsumerId, renderedByWebPart).catch(function (error) {
                    sp_diagnostics_1._TraceLogger.logError(logSource_1.logSource, error);
                });
                break;
    ...
    ContentPanelController.prototype.forceCloseContentPanel = function () {
        var _a;
    ...
    ContentPanelController.prototype.isComponentSupported = function (instanceId, consumer) {
        ...
        if (!consumer ||
            ...
            !(0, Flights_1.isConfigurationToolsEnabled)() ||
            excludedPanels_1.excludedPanels.has(instanceId)) {
            return false;
        }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._updateContentPanelData(componentId)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        subscriberContext.setLoader(sp_pages_content_panel_context_1.SPPagesContentPanelPath.configurationTools, function () {
                            var _a;
                            var qosMonitor = new sp_diagnostics_1._QosMonitor('ContentPanelController.renderPropertyPane');
                            return (_a = _this._consumers
                                .get(componentId)) === null || _a === void 0 ? void 0 : _a._getPropertyPaneData().then(function (propertyPaneData) {
     ...
     */
    ContentPanelController.prototype._closeContentPanel = function () {
