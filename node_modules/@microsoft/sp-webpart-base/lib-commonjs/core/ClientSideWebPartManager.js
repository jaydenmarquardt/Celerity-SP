...
var CanvasWebPartRenderTimeStampMap_1 = require("./CanvasWebPartRenderTimeStampMap");
...
var ClientSideWebPartManager = /** @class */ (function () {
    ...
    ClientSideWebPartManager.prototype.loadWebPart = function (webPartManagerContext) {
        ...
        try {
            ...
            var isACEWPManifest_1 = context_1.manifest.id === 'f3bc67ee-015d-4678-a95f-c7e90ea62c1e';
            var isIsolatedACEWPManifest_1 = context_1.manifest.id === ISOLATED_ACE_WP_MANIFEST_ID;
            var isACE_1 = context_1.manifest.componentType === 'AdaptiveCardExtension' ||
            ...
            if (isIsolated_1 && !isACE_1) {
                return this._loadIsolatedWebPart(context_1);
            }
            var syncTeamsComponentPromise = Promise.resolve();
            // detect Teams loading component
            if (isACE_1 && context_1.manifest.isPendingTeamsAppSync) {
                syncTeamsComponentPromise = this._waitForTeamsAppSync(context_1);
            }
            return syncTeamsComponentPromise.then(function () {
                // first, checking for permissions
                return _this._doesUserHasPermissions(context_1.manifest).then(function (hasPermissions) {
                    var _a, _b, _c, _d;
                    if (!hasPermissions) {
                        var errorMessage = sp_core_library_1.Text.format(Strings_resx_1.default.UserHasNoPermissionsError, ((_a = context_1.webPartData) === null || _a === void 0 ? void 0 : _a.title) || context_1.manifest.alias);
                        if (context_1.displayMode === sp_core_library_1.DisplayMode.Edit) {
                            if (!(0, KillSwitches_1.isShowErrorAceForBlockedAceKSActivated)()) {
                                ...
                                var _e = (0, getErrorAceLoadConfiguration_1.getErrorAceLoadConfiguration)(context_1.webPartData, errorMessage), errorAceManifest = _e.manifest, errorAceWebPartData = _e.webPartData;
                                context_1.manifest = errorAceManifest;
                                context_1.webPartData = errorAceWebPartData;
                            }
                            else {
                            ...
                            (_c = (_b = _this._host).onAfterWebPartVisibilityChanged) === null || _c === void 0 ? void 0 : _c.call(_b, context_1.instanceId, false);
                        }
                    }
                    if (isACE_1) {
                        // @todo [VSO:WEX!#1076592] Clean up temporary ACE WP upgrade code
                        ...
                        if ((!(0, KillSwitches_1.isIsolatedAdaptiveCardExtensionWebPropertyPaneWorkAroundKSActivated)() &&
                            ...
                            (!isACEWPManifest_1 && !isIsolated_1)) {
                        ...
                        if (context_1.webPartData) {
                            context_1.webPartData = tslib_1.__assign(tslib_1.__assign({}, context_1.webPartData), (_d = context_1.webPartData.properties) === null || _d === void 0 ? void 0 : _d.aceData);
                        }
                        if (context_1.displayMode === sp_core_library_1.DisplayMode.Edit &&
                            !(0, KillSwitches_1.isIsolatedAdaptiveCardExtensionIframedPropertyPaneKSActivated)() &&
                            isIsolated_1 &&
                            context_1.manifest.id === ISOLATED_ACE_WP_MANIFEST_ID) {
                            void _this._loadIsolatedWebPart(context_1, true);
                        }
                    }
                    ...
                    return (new Promise(function (resolve) {
                        ...
                        if (!(0, KillSwitches_1.isMeasurePerformanceImpactOfWebPartFlickerKSActivated)() && renderCompleteTime) {
                            CanvasWebPartRenderTimeStampMap_1.CanvasWebPartRenderTimeStampMap.endWithRenderCompleteTime(context_1.instanceId, renderCompleteTime);
                        }
    ...
    ClientSideWebPartManager.prototype.setWebPartData = function (context, instanceId, shouldFallback) {
        ...
        if (wp && webPartData) {
            if (!(0, KillSwitches_1.isMeasurePerformanceImpactOfWebPartFlickerKSActivated)()) {
                var monitor_1 = new sp_diagnostics_1._QosMonitor('WebPartExternalUpdatePerf_SetTimeout');
                requestAnimationFrame(function () {
                    // will execute right before next frame
                    setTimeout(function () {
                        // will execute right after the main thread frees up
                        monitor_1.writeSuccess({
                            manifestId: context.manifest.id,
                            shouldFallback: shouldFallback,
                            isInTreatment: CanvasWebPartRenderTimeStampMap_1.CanvasWebPartRenderTimeStampMap.isInTreatmentForWebPartFlickerPerfExp
                        });
                    }, 0);
                });
                CanvasWebPartRenderTimeStampMap_1.CanvasWebPartRenderTimeStampMap.endAndStartNewMonitor(instanceId, {
                    manifestId: context.manifest.id,
                    shouldFallback: !!context.manifest.useFallbackWhenPropertiesUpdatedExternally
                }, context.domElement);
            }
            if (shouldFallback) {
    ...
    ClientSideWebPartManager.prototype.notifyWebPartsSetDirtyBit = function () {
        if (!(0, KillSwitches_1.isAllowNotifyDirtyBitCheckKSActive)()) {
