...
var PreviewUtility = /** @class */ (function () {
    ...
    PreviewUtility.getAlternateUrl = function (resourcePath, width, height, originalWidth, originalHeight, cropMode, viewportTop, viewportLeft, viewportWidth, viewportHeight, cacheBuster) {
        ...
        if (alternativeUrl &&
            ...
            if ((0, ThumbnailHealingFlights_1.isAdvancedEditingFeatureEnabled)(ThumbnailHealingKillSwitches_1.isAdvancedEditVersioningKSActivated) && cacheBuster) {
    ...
    PreviewUtility.getVROOMThumbnailUrl = function (vroomItemUrl, width, height, cacheBuster, resolution, originalWidth, originalHeight, cropMode, viewportTop, viewportLeft, viewportWidth, viewportHeight, format) {
        ...
        if (vroomItemUrl) {
            ...
            var originalWidthHeightParams = originalWidth !== undefined && originalHeight !== undefined
                ...
                : '';
            var cacheBusterParam = !(0, ThumbnailHealingKillSwitches_1.isAdvancedEditVersioningKSActivated)() && cacheBuster !== undefined
                ? "&".concat(CACHE_BUSTER_PARAMETER, "=").concat(cacheBuster)
                : '';
            var formatParam = format !== undefined ? "&".concat(PreviewUtility.VROOM_FORMAT, "=").concat(format) : '';
            var urlPreferNoRedirectLegacy = "".concat(vroomItemUrl, "/thumbnails/0/c").concat(finalWidth, "x").concat(finalHeight, "/content?preferNoRedirect=true&").concat(PreviewUtility.PREFER, "=").concat(PreviewUtility.EXTEND_CACHE_MAXAGE, "&").concat(PreviewUtility.CLIENT_TYPE, "=").concat(PreviewUtility.MODERN_WEB_PART).concat(viewportParams).concat(cropModeParams).concat(originalWidthHeightParams).concat(cacheBusterParam).concat(formatParam);
            ...
            return !(0, ThumbnailHealingKillSwitches_1.isPreferNoRedirectUpdateKSActivated)() &&
                sp_core_library_1._SPFlight.isEnabled(60998 /* 	UpdatePreferParameterVROOMThumbnail */)
                ? urlPreferNoRedirect
                : urlPreferNoRedirectLegacy;
        }
        return undefined;
    };
    /**
