...
var _ThumbnailUrlGenerator = /** @class */ (function () {
    ...
    _ThumbnailUrlGenerator._getSPResourceAuthority = function (request) {
        var webAbsoluteUri = new SPResourcePath_1.SPResourcePath(request.absoluteUrl || (!(0, ThumbnailHealingKillSwitches_1.isFixAbsoluteUrlFallbackKSActivated)() ? location.href : ''));
        ...
        if ((isAspx ||
            ...
            if (isCroppingRequest || isCropModeSpecified) {
                ...
                var vroomFormatParam = !(0, ThumbnailHealingKillSwitches_1.isPassOptimizeFormatToVroomKSActivated)() &&
                    ...
                    : undefined;
                return PreviewUtility_1.PreviewUtility.getVROOMThumbnailUrl(vroomUrl, request.width, request.height, request.cacheBuster, undefined, //resolution?: number | undefined,
