...
var MsalBrowserTokenProvider = /** @class */ (function () {
    ...
    MsalBrowserTokenProvider.prototype.getTokenData = function (resourceEndpoint, optionsOrUseCachedToken, skipLoggingAndDisableRedirects) {
        ...
        this._updatePageEndVisibility(requestContext.telemetryData);
        if ((0, AadFlights_1.isPoPTokenFlightEnabled)() && options.authenticationScheme === ITokenProvider_1.IAuthenticationScheme.POP) {
            return this._getShrNonce(requestContext)
                ...
                return _this._getTokenDataInternal(requestContext, options);
            })
                .catch(function (error) {
                return Promise.reject(error);
            });
        }
        return this._getTokenDataInternal(requestContext, options);
    };
    ...
    /**
     * We have popup logic, however, MSAL V3 will prevent redirection when popup is in place.
     * Currently we try to run the popup logic and then trigger a redirect, and therefore
     * both fail.  Disabling it until the logic is added to only try the popup if it is supported.
     */
    MsalBrowserTokenProvider.prototype._shouldUsePopup = function () {
        return (0, AadKillSwitches_1.isPopupEnabledInV3KSActivated)();
    };
    /**
