...
var DeferredAadTokenProvider = /** @class */ (function () {
    ...
    DeferredAadTokenProvider.prototype._getTokenInternal = function (resourceEndpoint, configuration, optionsOrUseCachedToken) {
        ...
        if (this._shouldUseOboTokenExchange(tokenProviderConfig) && this._oboConfiguration) {
            if (!(0, AadKillSwitches_1.isEnsureAllTeamsScenarioDoNotUseOboFallbackKSActivated)()) {
                isOboForV3 =
                    (0, AadFlights_1.isMsalBrowserV3FlightEnabled)() &&
                        ...
                        !sp_core_library_1._BrowserUtilities.isTeamsVivaMobile() &&
            ...
            if (isOboForV3 && this._is3pOboInBadState) {
                ...
                getTokenPromise = this._getOboTokenProvider(tokenProviderConfig, this._oboConfiguration, this._oboFirstPartyTokenCallback, this._oboThirdPartyTokenCallback)
                    .then(function (tokenProvider) { return _this._getToken(tokenProvider, resourceEndpoint, options); })
            ...
            getTokenPromise = this._getMsalBrowserV3TokenProvider(tokenProviderConfig).then(function (tokenProvider) {
                return _this._getToken(tokenProvider, resourceEndpoint, options);
            });
        }
    ...
    DeferredAadTokenProvider.prototype._getMsalBrowserV3TokenProvider = function (configuration) {
        var _this = this;
        return Promise.resolve().then(function () { return tslib_1.__importStar(require('./chunks/msalV3/MsalBrowserTokenProvider' /* webpackChunkName: 'msalBrowser' */)); }).then(function (msalBrowserTokenProviderModule) {
            if (_this._isFirstParty(configuration.servicePrincipalId)) {
    ...
    DeferredAadTokenProvider.prototype._getMsalBrowserTokenProvider = function (configuration) {
        ...
        if ((0, AadFlights_1.isMsalBrowserFirstPartyBuildFlightEnabled)() || configuration.enableMetaOS) {
            return Promise.resolve().then(function () { return tslib_1.__importStar(require('./chunks/msal/current/v2/MsalBrowserTokenProvider' /* webpackChunkName: 'msalBrowser' */)); }).then(function (msalBrowserTokenProviderModule) {
                if (!_this._firstPartyMsalBrowserTokenProvider) {
                    _this._firstPartyMsalBrowserTokenProvider =
                        new msalBrowserTokenProviderModule.MsalBrowserTokenProvider(configuration);
                }
