    ...
    apply(compiler) {
        compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation) => {
            ...
            compilation.hooks.processAssets.tapPromise({
                ...
                const relativeAssetsReleasePath = path_1.default.relative(compiler.options.output.path, assetsReleasePath);
                const relativeManifestsReleasePath = path_1.default.relative(compiler.options.output.path, manifestsReleasePath);
