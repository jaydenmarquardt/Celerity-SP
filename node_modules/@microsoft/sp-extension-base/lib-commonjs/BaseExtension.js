...
var BaseExtension = /** @class */ (function (_super) {
    ...
    BaseExtension.prototype._init = function (context, propertiesJson, additionalInitParameters) {
        ...
        // Clean this property up with the graduation of loader KS 'b90e1867-5423-4e90-ae5b-c38e9faf3e89'
        if (!sp_core_library_1._SPKillSwitch.isActivated('b90e1867-5423-4e90-ae5b-c38e9faf3e89' /* 02-21-2024, track 3p code times */)) {
            sp_telemetry_1._PerformanceLogger.addExtensionInitTime({
                alias: this.context.manifest.alias,
                isInternal: this.context.manifest.isInternal === true,
