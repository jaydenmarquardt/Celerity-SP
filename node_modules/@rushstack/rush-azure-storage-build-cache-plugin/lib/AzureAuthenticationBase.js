...
class AzureAuthenticationBase {
    ...
    async _getCredentialAsync(terminal) {
        ...
        const deviceCodeCredential = new identity_1.DeviceCodeCredential(Object.assign(Object.assign({}, this._additionalDeviceCodeCredentialOptions), { authorityHost: authorityHost, userPromptCallback: (deviceCodeInfo) => {
