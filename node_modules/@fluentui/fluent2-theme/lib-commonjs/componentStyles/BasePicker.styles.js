...
exports.getBasePickerStyles = void 0;
var react_1 = require("@fluentui/react");
function getBasePickerStyles(props) {
    ...
    var styles = {
        text: [
            ...
            isFocused && !disabled && (0, react_1.getInputFocusStyle)(focusBorderColor, focusBorderRadius),
        ],
    };
    return styles;
}
exports.getBasePickerStyles = getBasePickerStyles;
