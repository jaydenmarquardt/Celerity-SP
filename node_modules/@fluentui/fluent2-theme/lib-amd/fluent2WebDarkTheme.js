define(["require", "exports", "tslib", "@fluentui/react", "./fluent2ComponentStyles", "./fluent2SharedColors", "./fluent2WebLightTheme"], function (require, exports, tslib_1, react_1, fluent2ComponentStyles_1, fluent2SharedColors_1, fluent2WebLightTheme_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Fluent2WebDarkTheme = void 0;
    var fluent2ForV8DarkEffects = {
    ...
    var fluent2ForV8DarkPalette = tslib_1.__assign({ 
        // properties are ordered here as in IPalette.ts
        themeDarker: '#62abf5', themeDark: '#479ef5', themeDarkAlt: '#479ef5', themePrimary: '#2886de', themeSecondary: '#2886de', themeTertiary: '#0f548c', themeLight: '#0e4775', themeLighter: '#0c3b5e', themeLighterAlt: '#0A2E4A', black: '#ffffff', blackTranslucent40: 'rgba(255 ,255 ,255 ,0.4)', neutralDark: '#fafafa', neutralPrimary: '#f5f5f5', neutralPrimaryAlt: '#d6d6d6', neutralSecondary: '#d1d1d1', neutralSecondaryAlt: '#8a8886', neutralTertiary: '#707070', neutralTertiaryAlt: '#424242', neutralQuaternary: '#3d3d3d', neutralQuaternaryAlt: '#2e2e2e', neutralLight: '#292929', neutralLighter: '#242424', neutralLighterAlt: '#1a1a1a', accent: '#2886de', white: '#141414', whiteTranslucent40: 'rgba(0, 0, 0, 0.4)' }, fluent2SharedColors_1.fluent2SharedColors);
    var p = fluent2ForV8DarkPalette;
    // shortcut since the gray scale isn't part of the v8 palette.
    var grey36 = '#5C5C5C';
    var semanticColorMappingOverridesForDark = {
        // Primary button is unique, it's background color is shared across themes
        primaryButtonBackgroundHovered: fluent2WebLightTheme_1.Fluent2WebLightTheme.palette.themePrimary,
        primaryButtonBackgroundPressed: fluent2WebLightTheme_1.Fluent2WebLightTheme.palette.themeDarker,
        primaryButtonBackground: fluent2WebLightTheme_1.Fluent2WebLightTheme.palette.themeDarkAlt,
    ...
    exports.Fluent2WebDarkTheme = (0, react_1.createTheme)({
...
//# sourceMappingURL=fluent2WebDarkTheme.js.map